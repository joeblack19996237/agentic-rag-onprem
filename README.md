...
This repository is currently in **Phase 1 (bootstrap)** of the build plan. There is no application logic yet — the codebase is a scaffold plus the first two Phase 1 issues:
...
- ⏳ Issue 03 — first failing smoke test (next up)
...
pytest tests/architecture/test_import_graph.py -q
```
