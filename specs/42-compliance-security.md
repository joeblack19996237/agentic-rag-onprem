...
- **Demo-ready is not government-procurement-ready — stated explicitly (added 2026-07-16, DEC-147, second cross-model review R.14)**: `09-deployment-ops.md`'s docker-compose deployment artifact is the MVP demo/pilot mechanism, not a vendor assessment package — AU public-sector procurement typically requires formal vendor assessment, IRAP assessment for protected data, and ASD Essential 8 alignment before a real deployment, none of which docker-compose itself satisfies or was designed to satisfy. `RISK-021` already tracks this and this file's own Explicit Scope Boundary section already excludes an IRAP/Essential-Eight attestation package — this line exists so a compliance reviewer doesn't have to infer the demo/procurement distinction from the absence of a claim
