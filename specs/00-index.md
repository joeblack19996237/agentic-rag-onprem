...
| 11 | `11-test-plan.md` | ~20 KB (grew post-Stage-8) | `TEST-001`..`TEST-040` (TEST-035..038 added Stage 8 fixes / DEC-128; TEST-039/040 added DEC-129); AI Evals section's judge-decoupling prose corrected 2026-07-08 (DEC-130 — NLI decoupling and RAGAS judge decoupling are separate mechanisms, not one substituting for the other); Test Environments table gains an "Agent execution sandbox" row, distinct from "Local/CI" (DEC-135, 2026-07-13) | `23-evals-guardrails.md` (golden set, cross-referenced not duplicated), `06-api-contracts.md`; closes RC-T8-01's remaining half |
